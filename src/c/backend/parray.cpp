...
namespace parray {
    ...
    uint64_t InnerPArray::get_size() {
        return this->_size;
    }

    void InnerPArray::set_size(uint64_t new_size) {
        this->_size = new_size;
    }
    ...
    TaskList& InnerPArray::get_task_list_ref() {
      return this->_task_lists;
    }

    void *InnerPArray::get_py_parray() {
      return this->_py_parray;
    }
}
