...
\item 
def \mbox{\hyperlink{classparla_1_1common_1_1dataflow_1_1Dataflow_a9bb78a8b3d8be65e7a653a2b3c5e87a6}{\+\_\+\+\_\+init\+\_\+\+\_\+}} (self, List\mbox{[}Union\mbox{[}crosspy.\+Cross\+Py\+Array, Tuple\mbox{[}\mbox{\hyperlink{classparla_1_1common_1_1parray_1_1core_1_1PArray}{PArray}}, int\mbox{]}\mbox{]}\mbox{]} \mbox{\hyperlink{classparla_1_1common_1_1dataflow_1_1Dataflow_ac4e3062a51d53eef90bcf6dbe33b08a9}{input}}, List\mbox{[}Union\mbox{[}crosspy.\+Cross\+Py\+Array, Tuple\mbox{[}\mbox{\hyperlink{classparla_1_1common_1_1parray_1_1core_1_1PArray}{PArray}}, int\mbox{]}\mbox{]}\mbox{]} \mbox{\hyperlink{classparla_1_1common_1_1dataflow_1_1Dataflow_ae6a6f21e88436c2d19a159aac0f0573c}{output}}, List\mbox{[}Union\mbox{[}crosspy.\+Cross\+Py\+Array, Tuple\mbox{[}\mbox{\hyperlink{classparla_1_1common_1_1parray_1_1core_1_1PArray}{PArray}}, int\mbox{]}\mbox{]}\mbox{]} \mbox{\hyperlink{classparla_1_1common_1_1dataflow_1_1Dataflow_a7f8382a92e81dad5844ee970172b4694}{inout}})
\item 
...
\item 
List\mbox{[}Tuple\mbox{[}\mbox{\hyperlink{classparla_1_1common_1_1parray_1_1core_1_1PArray}{PArray}}, int\mbox{]}\mbox{]} \mbox{\hyperlink{classparla_1_1common_1_1dataflow_1_1Dataflow_a2b852fe6df2926a4a2b54bf9de761be1}{process\+\_\+crosspys}} (self, List\mbox{[}Union\mbox{[}crosspy.\+Cross\+Py\+Array, Tuple\mbox{[}\mbox{\hyperlink{classparla_1_1common_1_1parray_1_1core_1_1PArray}{PArray}}, int\mbox{]}\mbox{]}\mbox{]} \+\_\+in)
\item 
...
Definition at line 45 of file dataflow.\+py.



\doxysubsection{Constructor \& Destructor Documentation}
\mbox{\Hypertarget{classparla_1_1common_1_1dataflow_1_1Dataflow_a9bb78a8b3d8be65e7a653a2b3c5e87a6}\label{classparla_1_1common_1_1dataflow_1_1Dataflow_a9bb78a8b3d8be65e7a653a2b3c5e87a6}} 
...
{\footnotesize\ttfamily def parla.\+common.\+dataflow.\+Dataflow.\+\_\+\+\_\+init\+\_\+\+\_\+ (\begin{DoxyParamCaption}\item[{}]{self,  }\item[{List\mbox{[}Union\mbox{[}crosspy.\+Cross\+Py\+Array, Tuple\mbox{[}\mbox{\hyperlink{classparla_1_1common_1_1parray_1_1core_1_1PArray}{PArray}}, int\mbox{]}\mbox{]}\mbox{]}}]{input,  }\item[{List\mbox{[}Union\mbox{[}crosspy.\+Cross\+Py\+Array, Tuple\mbox{[}\mbox{\hyperlink{classparla_1_1common_1_1parray_1_1core_1_1PArray}{PArray}}, int\mbox{]}\mbox{]}\mbox{]}}]{output,  }\item[{List\mbox{[}Union\mbox{[}crosspy.\+Cross\+Py\+Array, Tuple\mbox{[}\mbox{\hyperlink{classparla_1_1common_1_1parray_1_1core_1_1PArray}{PArray}}, int\mbox{]}\mbox{]}\mbox{]}}]{inout }\end{DoxyParamCaption})}



Definition at line 52 of file dataflow.\+py.


\begin{DoxyCode}{0}
\DoxyCodeLine{54                  inout: List[Union[crosspy.CrossPyArray, Tuple[PArray, int]]]):}
\DoxyCodeLine{55         self.\_input = self.process\_crosspys(input)}
\DoxyCodeLine{56         self.\_output = self.process\_crosspys(output)}
\DoxyCodeLine{57         self.\_inout = self.process\_crosspys(inout)}
\DoxyCodeLine{58 }
...
Definition at line 106 of file dataflow.\+py.


\begin{DoxyCode}{0}
\DoxyCodeLine{106     \textcolor{keyword}{def }\_\_iter\_\_(self):}
\DoxyCodeLine{107         \textcolor{keywordflow}{return} DataflowIterator(self)}
...
Definition at line 72 of file dataflow.\+py.


\begin{DoxyCode}{0}
\DoxyCodeLine{72     \textcolor{keyword}{def }inout(self) -\/> List:}
\DoxyCodeLine{73         \textcolor{keywordflow}{if} self.\_inout \textcolor{keywordflow}{is} \textcolor{keywordtype}{None}:}
\DoxyCodeLine{74             \textcolor{keywordflow}{return} []}
\DoxyCodeLine{75         \textcolor{keywordflow}{return} self.\_inout}
\DoxyCodeLine{76 }
...
Definition at line 60 of file dataflow.\+py.


\begin{DoxyCode}{0}
\DoxyCodeLine{60     \textcolor{keyword}{def }input(self) -\/> List:}
\DoxyCodeLine{61         \textcolor{keywordflow}{if} self.\_input \textcolor{keywordflow}{is} \textcolor{keywordtype}{None}:}
\DoxyCodeLine{62             \textcolor{keywordflow}{return} []}
\DoxyCodeLine{63         \textcolor{keywordflow}{return} self.\_input}
\DoxyCodeLine{64 }
...
Definition at line 66 of file dataflow.\+py.


\begin{DoxyCode}{0}
\DoxyCodeLine{66     \textcolor{keyword}{def }\mbox{\hyperlink{namespaceparla_1_1cython_1_1tasks_a4e4004f34c57f2440d72f08f43b9d9ce}{output}}(self) -\/> List:}
\DoxyCodeLine{67         \textcolor{keywordflow}{if} self.\_output \textcolor{keywordflow}{is} \textcolor{keywordtype}{None}:}
\DoxyCodeLine{68             \textcolor{keywordflow}{return} []}
\DoxyCodeLine{69         \textcolor{keywordflow}{return} self.\_output}
\DoxyCodeLine{70 }
...
\mbox{\Hypertarget{classparla_1_1common_1_1dataflow_1_1Dataflow_a2b852fe6df2926a4a2b54bf9de761be1}\label{classparla_1_1common_1_1dataflow_1_1Dataflow_a2b852fe6df2926a4a2b54bf9de761be1}} 
...
Definition at line 77 of file dataflow.\+py.


\begin{DoxyCode}{0}
\DoxyCodeLine{79             -\/> List[Tuple[PArray, int]]:}
\DoxyCodeLine{80         \textcolor{stringliteral}{"{}"{}"{}}}
\DoxyCodeLine{81 \textcolor{stringliteral}{        Check elements of IN/OUT/INOUT parameters in @spawn}}
\DoxyCodeLine{82 \textcolor{stringliteral}{        and convert to Tuple[PArray, int] if an element is a CrossPyArray}}
\DoxyCodeLine{83 \textcolor{stringliteral}{        "{}"{}"{}}}
\DoxyCodeLine{84         \_out = []}
\DoxyCodeLine{85         \textcolor{keywordflow}{if} \_in \textcolor{keywordflow}{is} \textcolor{keywordflow}{not} \textcolor{keywordtype}{None}:}
\DoxyCodeLine{86             \textcolor{keywordflow}{for} element \textcolor{keywordflow}{in} \_in:}
\DoxyCodeLine{87                 \textcolor{keywordflow}{if} isinstance(element, PArray):}
\DoxyCodeLine{88                     element = (element, 0)}
\DoxyCodeLine{89                 \textcolor{keywordflow}{if} isinstance(element, tuple):}
\DoxyCodeLine{90                     \textcolor{keyword}{assert} isinstance(element[0], PArray)}
\DoxyCodeLine{91                     \textcolor{keyword}{assert} isinstance(element[1], int)}
\DoxyCodeLine{92                     \_out.append(element)}
\DoxyCodeLine{93                 \textcolor{keywordflow}{elif} CROSSPY\_ENABLED \textcolor{keywordflow}{and} isinstance(element, crosspy.CrossPyArray):}
\DoxyCodeLine{94                     \textcolor{comment}{\# A Crosspy's partition number is corresponding}}
\DoxyCodeLine{95                     \textcolor{comment}{\# to an order of the placement.}}
\DoxyCodeLine{96                     \textcolor{keywordflow}{for} i, parray\_list \textcolor{keywordflow}{in} enumerate(element.device\_view()):}
\DoxyCodeLine{97                         \textcolor{keywordflow}{for} parray \textcolor{keywordflow}{in} parray\_list:}
\DoxyCodeLine{98                             \textcolor{keywordflow}{if} isinstance(parray, PArray):}
\DoxyCodeLine{99                                 \textcolor{comment}{\# Skip CuPy or NumPy arrays.}}
\DoxyCodeLine{100                                 \_out.append((parray, i))}
\DoxyCodeLine{101                 \textcolor{keywordflow}{else}:}
\DoxyCodeLine{102                     \textcolor{keywordflow}{raise} TypeError(\textcolor{stringliteral}{"{}IN/OUT/INOUT should be either a tuple of PArray"{}},}
\DoxyCodeLine{103                                     \textcolor{stringliteral}{"{}and its partition number or CrossPyArray"{}})}
\DoxyCodeLine{104         \textcolor{keywordflow}{return} \_out}
\DoxyCodeLine{105 }
...
Definition at line 55 of file dataflow.\+py.
