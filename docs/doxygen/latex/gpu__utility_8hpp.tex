...
Definition at line 34 of file gpu\+\_\+utility.\+hpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{34                                                \{}
\DoxyCodeLine{35   \textcolor{comment}{// compute\_range r("{}sleep::busy"{}, nvtx3::rgb\{0, 127, 127\});}}
\DoxyCodeLine{36   \textcolor{comment}{// int count = 0;}}
\DoxyCodeLine{37   \textcolor{keyword}{auto} block = std::chrono::microseconds(micro);}
\DoxyCodeLine{38   \textcolor{keyword}{auto} time\_start = std::chrono::high\_resolution\_clock::now();}
\DoxyCodeLine{39 }
\DoxyCodeLine{40   \textcolor{keyword}{auto} now = std::chrono::high\_resolution\_clock::now();}
\DoxyCodeLine{41   \textcolor{keyword}{auto} elapsed =}
\DoxyCodeLine{42       std::chrono::duration\_cast<std::chrono::microseconds>(now -\/ time\_start);}
\DoxyCodeLine{43 }
\DoxyCodeLine{44   \textcolor{keywordflow}{do} \{}
\DoxyCodeLine{45     now = std::chrono::high\_resolution\_clock::now();}
\DoxyCodeLine{46     elapsed =}
\DoxyCodeLine{47         std::chrono::duration\_cast<std::chrono::microseconds>(now -\/ time\_start);}
\DoxyCodeLine{48   \} \textcolor{keywordflow}{while} (elapsed.count() < micro);}
\DoxyCodeLine{49 \}}
