...
Definition at line 261 of file array.\+py.


\begin{DoxyCode}{0}
\DoxyCodeLine{261 \textcolor{keyword}{def }\mbox{\hyperlink{namespaceparla_1_1common_1_1array_a2fb98621d2f781a43f8922f7b5015cac}{clone\_here}}(source, kind=None):}
\DoxyCodeLine{262     \textcolor{stringliteral}{"{}"{}"{}}}
\DoxyCodeLine{263 \textcolor{stringliteral}{    Create a local copy of `source` stored at the current location.}}
\DoxyCodeLine{264 \textcolor{stringliteral}{    :param source: The array to read from.}}
\DoxyCodeLine{265 \textcolor{stringliteral}{    "{}"{}"{}}}
\DoxyCodeLine{266     \textcolor{keywordflow}{if} CROSSPY\_ENABLED \textcolor{keywordflow}{and} isinstance(source, crosspy.CrossPyArray):}
\DoxyCodeLine{267 }
\DoxyCodeLine{268         \textcolor{comment}{\#FIXME: This only works on unwrapped CrossPy Arrays}}
\DoxyCodeLine{269         \textcolor{comment}{\#FIXME: This doesn't work on noncontigious colorings as it will not copy the index map}}
\DoxyCodeLine{270         }
\DoxyCodeLine{271         current\_context = \mbox{\hyperlink{namespaceparla_1_1common_1_1globals_a984f8b4c44f904aec08e3fe4cbcab416}{get\_current\_context}}()}
\DoxyCodeLine{272 }
\DoxyCodeLine{273         \textcolor{comment}{\#Our semantics are only defined when the context contains more components than the source array.}}
\DoxyCodeLine{274         \textcolor{comment}{\#assert (len(current\_context.devices) > len(source.block\_view()))}}
\DoxyCodeLine{275 }
\DoxyCodeLine{276         \textcolor{comment}{\#We need to copy the array to the current context.}}
\DoxyCodeLine{277         \textcolor{comment}{\#From left to right, we copy each "{}block"{} of the array to the corresponding device.}}
\DoxyCodeLine{278         array\_list = []}
\DoxyCodeLine{279         \textcolor{keywordflow}{for} i, block \textcolor{keywordflow}{in} enumerate(source.block\_view()):}
\DoxyCodeLine{280             \textcolor{keyword}{with} current\_context.devices[i]:}
\DoxyCodeLine{281                 array\_list.append(\mbox{\hyperlink{namespaceparla_1_1common_1_1array_a2fb98621d2f781a43f8922f7b5015cac}{clone\_here}}(block))}
\DoxyCodeLine{282 }
\DoxyCodeLine{283         \textcolor{keywordflow}{return} crosspy.array(array\_list, axis=0)}
\DoxyCodeLine{284 }
\DoxyCodeLine{285     \textcolor{keywordflow}{elif} \mbox{\hyperlink{namespaceparla_1_1common_1_1array_a268e77177f856cc7a8be5c5b449fcdb8}{is\_array}}(source):}
\DoxyCodeLine{286 }
\DoxyCodeLine{287         \textcolor{comment}{\#FIXME: This doesn't work on PArrays}}
\DoxyCodeLine{288 }
\DoxyCodeLine{289         current\_content = \mbox{\hyperlink{namespaceparla_1_1common_1_1globals_a984f8b4c44f904aec08e3fe4cbcab416}{get\_current\_context}}()}
\DoxyCodeLine{290 }
\DoxyCodeLine{291         \textcolor{keywordflow}{if} current\_content \textcolor{keywordflow}{is} \textcolor{keywordtype}{None}:}
\DoxyCodeLine{292             \textcolor{keywordflow}{raise} ValueError(}
\DoxyCodeLine{293                 \textcolor{stringliteral}{"{}No device context exists for the current copy. Operation is ambiguous."{}})}
\DoxyCodeLine{294         \textcolor{keywordflow}{if} len(current\_content.devices) != 1:}
\DoxyCodeLine{295             \textcolor{keywordflow}{raise} ValueError(}
\DoxyCodeLine{296                 \textcolor{stringliteral}{"{}Multiple devices exist for the current copy. Operation is ambiguous."{}})}
\DoxyCodeLine{297 }
\DoxyCodeLine{298         current\_device = current\_content.devices[0]}
\DoxyCodeLine{299 }
\DoxyCodeLine{300         \textcolor{comment}{\# FIXME: Make this a property of the device}}
\DoxyCodeLine{301         \textcolor{keywordflow}{if} (current\_device.architecture == DeviceType.CUDA) \textcolor{keywordflow}{and} CUPY\_ENABLED:}
\DoxyCodeLine{302             AType = CupyArray()}
\DoxyCodeLine{303         \textcolor{keywordflow}{else}:}
\DoxyCodeLine{304             AType = NumpyArray()}
\DoxyCodeLine{305 }
\DoxyCodeLine{306         target\_device\_id = current\_device().device\_id}
\DoxyCodeLine{307         dst = AType.copy\_from(source, target\_device\_id)}
\DoxyCodeLine{308 }
\DoxyCodeLine{309         \textcolor{keywordflow}{return} dst}
\DoxyCodeLine{310 }
\DoxyCodeLine{311     \textcolor{keywordflow}{else}:}
\DoxyCodeLine{312         \textcolor{keywordflow}{raise} TypeError(}
\DoxyCodeLine{313             \textcolor{stringliteral}{"{}ArrayType required, given value of type \{\}"{}}.format(type(source)))}
\DoxyCodeLine{314 }
\DoxyCodeLine{315 }
...
\DoxyCodeLine{245     \textcolor{comment}{\#FIXME: This doesn't work on PArrays or CrossPyArrays}}
\DoxyCodeLine{246 }
\DoxyCodeLine{247     \textcolor{keywordflow}{try}:}
\DoxyCodeLine{248         \textcolor{keywordflow}{if} \mbox{\hyperlink{namespaceparla_1_1common_1_1array_a268e77177f856cc7a8be5c5b449fcdb8}{is\_array}}(source):}
\DoxyCodeLine{249             \_array\_types[type(destination)].copy\_into(source, destination)}
\DoxyCodeLine{250         \textcolor{keywordflow}{else}:}
\DoxyCodeLine{251             \textcolor{comment}{\# We assume all non-\/array types are by-\/value and hence already exist in the Python interpreter}}
\DoxyCodeLine{252             \textcolor{comment}{\# and don't need to be copied.}}
\DoxyCodeLine{253             destination[:] = source}
\DoxyCodeLine{254     \textcolor{keywordflow}{except} ValueError \textcolor{keyword}{as} e:}
\DoxyCodeLine{255         print(\textcolor{stringliteral}{"{}Error in copy: "{}}, e)}
\DoxyCodeLine{256         \textcolor{keywordflow}{raise} ValueError(\textcolor{stringliteral}{"{}Failed to copy (\{\} \{\} to \{\} \{\})"{}}.format(source, getattr(}
\DoxyCodeLine{257             source, \textcolor{stringliteral}{"{}shape"{}}, \textcolor{keywordtype}{None}),}
\DoxyCodeLine{258             destination, getattr(destination, \textcolor{stringliteral}{"{}shape"{}}, \textcolor{keywordtype}{None}))) \textcolor{keyword}{from} e}
\DoxyCodeLine{259 }
\DoxyCodeLine{260 }
...
Definition at line 316 of file array.\+py.


\begin{DoxyCode}{0}
\DoxyCodeLine{316 \textcolor{keyword}{def }\mbox{\hyperlink{namespaceparla_1_1common_1_1array_ae1227110199451602c5479dda1e9df5e}{storage\_size}}(*arrays):}
\DoxyCodeLine{317     \textcolor{stringliteral}{"{}"{}"{}}}
\DoxyCodeLine{318 \textcolor{stringliteral}{    :return: the total size of the arrays passed as arguments.}}
\DoxyCodeLine{319 \textcolor{stringliteral}{    "{}"{}"{}}}
\DoxyCodeLine{320     \textcolor{keywordflow}{return} sum(a.size * a.itemsize \textcolor{keywordflow}{for} a \textcolor{keywordflow}{in} arrays)}
