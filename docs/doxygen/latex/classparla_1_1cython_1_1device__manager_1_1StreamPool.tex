...
Definition at line 80 of file device\+\_\+manager.\+pyx.
...
Definition at line 82 of file device\+\_\+manager.\+pyx.


\begin{DoxyCode}{0}
\DoxyCodeLine{82     \textcolor{keyword}{def }\mbox{\hyperlink{namespaceparla_1_1cython_1_1core_abd75527c775e8a2eda6c2bd84fc0761a}{\_\_init\_\_}}(self, device\_list, per\_device=8):}
\DoxyCodeLine{83 }
\DoxyCodeLine{84         \textcolor{keywordflow}{if} CUPY\_ENABLED:}
\DoxyCodeLine{85             self.StreamClass = CupyStream }
\DoxyCodeLine{86         \textcolor{keywordflow}{else}:}
\DoxyCodeLine{87             self.StreamClass = Stream}
\DoxyCodeLine{88 }
\DoxyCodeLine{89         self.\_device\_list = device\_list}
\DoxyCodeLine{90         self.\_per\_device = per\_device}
\DoxyCodeLine{91         self.\_pool = \{\}}
\DoxyCodeLine{92 }
\DoxyCodeLine{93         \textcolor{keywordflow}{for} device \textcolor{keywordflow}{in} self.\_device\_list:}
\DoxyCodeLine{94             self.\_pool[device] = []}
\DoxyCodeLine{95             }
\DoxyCodeLine{96             \textcolor{keyword}{with} device.device \textcolor{keyword}{as} d:}
\DoxyCodeLine{97                 \textcolor{keywordflow}{for} i \textcolor{keywordflow}{in} range(self.\_per\_device):}
\DoxyCodeLine{98                     self.\_pool[device].append(self.StreamClass(device=device))}
\DoxyCodeLine{99 }
...
Definition at line 118 of file device\+\_\+manager.\+pyx.


\begin{DoxyCode}{0}
\DoxyCodeLine{118     \textcolor{keyword}{def }\_\_repr\_\_(self):}
\DoxyCodeLine{119         \textcolor{keywordflow}{return} f\textcolor{stringliteral}{"{}StreamPool(\{self.\_\_summarize\_\_()\})"{}}}
\DoxyCodeLine{120 }
\DoxyCodeLine{121 }
\DoxyCodeLine{122 \textcolor{comment}{\#TODO(wlr):  -\/ Allow device manager to initialize non-\/contiguous gpu ids. }}
\DoxyCodeLine{123 \textcolor{comment}{\#TODO(wlr):  -\/ Provide a way to iterate over these real device ids}}
\DoxyCodeLine{124            }
\DoxyCodeLine{125 }
...
Definition at line 111 of file device\+\_\+manager.\+pyx.


\begin{DoxyCode}{0}
\DoxyCodeLine{111     \textcolor{keyword}{def }\_\_summarize\_\_(self):}
\DoxyCodeLine{112         summary  = \textcolor{stringliteral}{"{}"{}}}
\DoxyCodeLine{113         \textcolor{keywordflow}{for} device \textcolor{keywordflow}{in} self.\_device\_list:}
\DoxyCodeLine{114             summary += f\textcolor{stringliteral}{"{}(\{device\} : \{len(self.\_pool[device])\})"{}}}
\DoxyCodeLine{115 }
\DoxyCodeLine{116         \textcolor{keywordflow}{return} summary}
\DoxyCodeLine{117 }
...
Definition at line 100 of file device\+\_\+manager.\+pyx.


\begin{DoxyCode}{0}
\DoxyCodeLine{100     \textcolor{keyword}{def }get\_stream(self, device):}
\DoxyCodeLine{101         \textcolor{keywordflow}{if} len(self.\_pool[device]) == 0:}
\DoxyCodeLine{102             \textcolor{comment}{\#Create a new stream if the pool is empty.}}
\DoxyCodeLine{103             new\_stream = self.StreamClass(device=device)}
\DoxyCodeLine{104             \textcolor{keywordflow}{return} new\_stream}
\DoxyCodeLine{105 }
\DoxyCodeLine{106         \textcolor{keywordflow}{return} self.\_pool[device].pop()}
\DoxyCodeLine{107 }
...
Definition at line 108 of file device\+\_\+manager.\+pyx.


\begin{DoxyCode}{0}
\DoxyCodeLine{108     \textcolor{keyword}{def }return\_stream(self, stream):}
\DoxyCodeLine{109         self.\_pool[stream.device].append(stream)}
\DoxyCodeLine{110 }
...
Definition at line 91 of file device\+\_\+manager.\+pyx.
...
Definition at line 85 of file device\+\_\+manager.\+pyx.
