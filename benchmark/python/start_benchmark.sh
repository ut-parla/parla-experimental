...
#GRAPH_TYPES_STR=( "independent" "reduction" )
...
GRAPH_INPUT_DIR="asplos24_nodata_input"
rm -rf $GRAPH_INPUT_DIR
mkdir $GRAPH_INPUT_DIR

OUTPUT_DIR="asplos24_nodata_output"
rm -rf $OUTPUT_DIR
mkdir $OUTPUT_DIR
              ...
              for level in "${LEVELS[@]}"; do
                for num_gpus in "${!NUM_GPUS_SET[@]}"; do
                  ...
                  for data_move_mode in "${DATA_MOVE_MODES[@]}"; do
                    ...
                    output_prefix="${GRAPH_TYPE}_${fd_data_knob}_${sd_data_knob}_${computation_time}_${user_chosen_placement}_${level}_${ng}_${data_move_mode}_${out_iter}"
              ...
              for num_task in "${NUM_TASKS_SET[@]}"; do
                for num_gpus in "${!NUM_GPUS_SET[@]}"; do
                  ...
                  for data_move_mode in "${DATA_MOVE_MODES[@]}"; do
                    ...
                    output_prefix="${GRAPH_TYPE}_${fd_data_knob}_${sd_data_knob}_${computation_time}_${user_chosen_placement}_${num_task}_${ng}_${data_move_mode}_${out_iter}"
                    if [[ ${fd_data_knob} == 0 ]]; then
                        output_prefix+=".nodata"
                    fi
                    commands="python "${DIR}"/benchmark.py -graph ${GRAPH_INPUT_DIR}/${output_prefix}.gph "$FLAGS
